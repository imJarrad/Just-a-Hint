  ...
  **Mineral-based substance, white powder, used to clean, can be found in laundry and cleaning products, cleaning agent, has many properties, soapy texture, often used in gardening, often found in detergents, found in nature, has a variety of uses, used in many household products.**
