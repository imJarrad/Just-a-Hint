...
**Cleaning agent, used for making laundry detergent, sodium-based compound, crystalized form of sodium borate, white powdery substance, mineral, useful in many household applications, often used in fire retardants, found in nature, often used as a buffer, has multiple household uses, often used as a preservative.**
